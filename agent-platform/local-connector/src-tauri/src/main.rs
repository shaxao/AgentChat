...
use ide::{
    ...
    ide_agent_memory_update, ide_agent_message_inject, ide_agent_message_send,
    ide_agent_plan_save, ide_agent_process_kill, ide_agent_processes, ide_agent_profiles,
    ide_agent_run, ide_agent_send,
